...
public class YoutubeSearch {
    ...
    public VideoSnippet getYtVideoDataById(String videoId) {
        try {
            YouTube.Videos.List videos = youtube.videos().list(List.of("snippet"));
            videos.setKey(Menmu.getConfig().youtubeApiKey);
            videos.setId(List.of(videoId));
    ...
    public Map<String, PlaylistItemSnippet> getYtVideoPlaylistById(String playlistId) {
        try {
            YouTube.PlaylistItems.List playlistItems = youtube.playlistItems().list(List.of("snippet"));
